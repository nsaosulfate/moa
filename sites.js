...
window.SITES = [

  {
    ...
    url: "https://clayborneyeounjunlee.github.io/haru/",
    icon: "하",
    color: "#2f9e63",
    color2: "#43c07a",
    tags: ["생산성", "루틴", "PWA"]
...

  {
    ...
    url: "https://clayborneyeounjunlee.github.io/dday/",
    icon: "D",
    color: "#2563eb",
    color2: "#4f8cff",
    tags: ["공익", "전역", "캘린더", "계산기"]
...

  {
    ...
    url: "https://clayborneyeounjunlee.github.io/kazu/",
    icon: "数",
    color: "#0ea5a4",
    color2: "#22c7b8",
    tags: ["일본어", "숫자", "암기"]
...

  {
    ...
    url: "https://clayborneyeounjunlee.github.io/tonggeun/",
    icon: "통",
    color: "#2563eb",
    color2: "#4f8cff",
    tags: ["지도", "지하철", "통근", "수도권"]
...

  {
    ...
    url: "https://clayborneyeounjunlee.github.io/tonggeun-mel/",
    icon: "M",
    color: "#1f7a4d",
    color2: "#28a06a",
    tags: ["지도", "기차", "통근", "멜버른"]
...

  {
    ...
    url: "https://clayborneyeounjunlee.github.io/jangbu/",
    icon: "₩",
    color: "#7c5cff",
    color2: "#9d86ff",
    tags: ["가계부", "지출", "돈", "도구"]
